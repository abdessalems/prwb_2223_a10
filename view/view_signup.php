    ...
    <form id="signupForm" action="main/signup" method="post">
        <table>
            ...
            <div class="input-group mb-3">
                ...
                <input id="mail" name="mail" type="mail" size="16" placeholder="Email" value="<?php if (isset($mail)) {
                    echo $mail;
            ...
            <div class="input-group mb-3">
                ...
                <input id="fullname" name="fullname" type="text" size="16" placeholder="Full Name"
            ...
            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1"><i class="fa-credit-card"
                                                                    aria-hidden="true"></i></span>
                <input id="iban" name="iban" type="text" size="16" placeholder="IBAN" value="<?php if (isset($iban)) {
                    echo $iban;
                } ?>" class="form-control" p aria-label="Username" aria-describedby="basic-addon1">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-lock" aria-hidden="true"></i></span>
                <input id="password" name="password" type="password" size="16" placeholder="Password"
                       class="form-control" aria-label="Username" aria-describedby="basic-addon1">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-lock" aria-hidden="true"></i></span>
                <input <input id="password_confirm" name="password_confirm" type="password" size="16"
                              placeholder="Confirm Your Password" class="form-control" aria-label="Username"
