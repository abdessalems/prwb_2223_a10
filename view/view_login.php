...
<body>
<div class="container">
    <form action="main/login" class="row g-3 needs-validation" method="post">
        <div class="d-flex justify-content-center py-4">
            <a href="tricount/logout" class="logo d-flex align-items-center w-auto">
                <img src="./assets/img/fav_icon.png" alt="">
                <span class="d-none d-lg-block">My Tricount</span>
            </a>
        </div><!-- End Logo -->
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input id="email" name="mail" type="text" value="<?= $mail ?>">
