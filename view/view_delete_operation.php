...
<!--</head>-->
<!--<body>-->
<!--<div style="width: 50px; height: 50px; border: 1px solid black; text-align: center;">-->
<!--    <i class="fas fa-trash" aria-hidden="true" style="font-size: 40px;"></i>-->
<!--</div>-->
<!---->
<!--<button> <a href='tricount/tricount'>Cancel</a> </button>-->
<!---->
<!--<button> <a href='operation/delete_confirmation/--><?php //= $operation->id ?><!--'>Delete </a> </button>-->
<!--</body>-->
<!--</html>-->
