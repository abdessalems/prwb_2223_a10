...
<!--    </div>-->
<!--    <div style="display: flex; justify-content: center; width: 100%; margin-top: 10px;">-->
<!--        <p style="color: red;">Do you really want to delete this operation "<strong style="color:red;">--><?php //= $operation->title ?><!--</strong>" and all of its dependencies?</p>-->
<!--        <br>-->
...
<!--            <a href='operation/delete_confirmation/--><?php //= $operation->id ?><!--' style="color:white;">Delete</a>-->
<!--        </button>-->
<!--    </div>-->
<!---->
<!--</body>-->
