...
<div class="card-header">
    <div class="d-flex w-100 justify-content-between">
        ...
        <h5 style="align-self: center " class="card-title"><?= $tricount->title ?> > Expenses <h5/>
            <a data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit tricount" class="btn btn-primary"
               href="tricount/EditTricounts/<?= $tricount->id ?>/<?= $id_user ?>">Edit </a>
    </div>
...
<div class="card mx-2">
    ...
    <?php else : ?>
        <div class="list-group">
            <a class="btn btn btn-success" href="tricount/view_balance/<?= $tricount->id ?>/<?= $id_user ?> "> <i
                        class="bi bi-arrow-left-right"></i> view balance </a>
            <?php foreach ($operations as $operation): ?>
                <a href="operation/view_operation/<?= $operation->id ?>/<?= $id_user ?>"
